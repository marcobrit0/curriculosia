...
description: "Learn how to access the previous version (v4) of Currículos IA if you need to retrieve old resumes or prefer the classic experience."
---

## The previous version is still available

If you've been using Currículos IA for a while, you may have resumes saved in the previous version of the application. The good news is that **version 4 (v4) is still fully accessible** and will remain online for the foreseeable future.

<Info>The previous version of Currículos IA is available at [https://v4.curriculos.ia.br](https://v4.curriculos.ia.br).</Info>
...
<Steps>
  <Step title="Visit the v4 application">
    Go to [https://v4.curriculos.ia.br](https://v4.curriculos.ia.br) in your browser.
  </Step>
...
If you'd like to move your resumes to the latest version of Currículos IA, you can export them from v4 and import them into the new version:

1. In v4, open the resume you want to migrate
2. Export it as a JSON file
3. In the new version at [https://curriculos.ia.br](https://curriculos.ia.br), create a new account or log in
4. Use the import feature to upload your JSON file (select the "Currículos IA v4 (JSON)" option)
...
If you encounter any problems accessing v4 or have questions about migrating your resumes, feel free to open an issue on [GitHub](https://github.com/marcobrit0/curriculosia/issues).
