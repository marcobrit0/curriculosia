...
description: "Learn how to choose the perfect template for your resume and explore all available template designs in Currículos IA."
---

Currículos IA offers a variety of unique templates, each with its own design aesthetic. This guide will help you understand the differences between templates and how to change your resume's template at any time.
...
Currículos IA includes a variety of professionally designed templates. Each template can be further customized with your choice of colors, fonts, and layout options.
