...
When your resume content overflows the page, Currículos IA displays a warning just below the page. This guide explains how to reorganize and adjust your content so everything fits within your chosen page format.
...
<Warning>
  While Currículos IA supports multi-page resumes, each page has a fixed height based on your chosen format (A4 or
