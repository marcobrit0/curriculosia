...
Currículos IA lets you share your resume via a **public URL** that anyone can access. When you make your resume public, it becomes available at a unique link that you can share with recruiters, include in your portfolio, or add to your LinkedIn profile.
...
<Step title="Toggle 'Allow Public Access'">
  ...
  <Step title="Copy your public URL">
    ...
    ```
    https://curriculos.ia.br/{username}/{slug}
    ```
...
2. **No account required** - Visitors don't need a Currículos IA account to view or download your resume
...
When your resume is public, Currículos IA tracks how many times it has been viewed and downloaded. This helps you understand engagement and see if people are actually looking at your resume.
...
<Accordion title="Can I see who viewed my resume?">
  No, Currículos IA only tracks view and download counts, not the identity of visitors. This protects visitor privacy.
</Accordion>
