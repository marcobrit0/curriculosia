...
description: "Learn how to create an account on Currículos IA and get started on building your resume"
---

<Steps>
  <Step title="Visit the homepage">
    Head over to [https://curriculos.ia.br](https://curriculos.ia.br) and click on the <Badge>Get Started</Badge> button.
  </Step>
  ...
  <Step title="Fill in your details">
    ...
    <Warning>
      Make sure to choose a username you're happy with, as it will be part of your public resume URL (e.g., `curriculos.ia.br/your-username/resume-slug`).
    </Warning>

  </Step>
  
  <Step title="Sign up and log in">
    After filling in all the required fields, click the **Sign Up** button. You will be immediately logged in and can start using Currículos IA right away.
