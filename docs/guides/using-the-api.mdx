---
title: "Using the API"
description: "Learn how to create API keys and authenticate requests to the Currículos IA API"
---
...
<Step title="Navigate to API Keys settings">
  ...
  <Step title="Open the API reference">
    ...
    <Tip>
      You can also open it directly here: [API Reference](https://docs.curriculos.ia.br/api-reference).
    </Tip>
  ...
  <Step title="Authenticate requests with x-api-key">
    ...
    <Info>
      If you're self-hosting, replace <code>https://curriculos.ia.br</code> with your instance URL. The API is served under <code>/api/openapi</code>.
    </Info>

    ```bash
    curl "https://curriculos.ia.br/api/openapi/resumes" \
