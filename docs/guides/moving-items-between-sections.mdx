...
<Step title="Hover over 'Move to'">
  ...
  <Step title="Select a destination">
    ...
    <Tip>
      If a custom section of the same type doesn't exist on your target page, Currículos IA will **automatically create one** for you. This makes it easy to split sections across pages without manual setup.
    </Tip>
