...
<Info>
  If you're self-hosting, replace `https://curriculos.ia.br` with your instance URL. The API is served under `/api/openapi`.
</Info>
...
```bash
curl -X PATCH "https://curriculos.ia.br/api/openapi/resume/YOUR_RESUME_ID" \
