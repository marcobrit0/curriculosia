...
description: "Learn how to create your first resume in Currículos IA, set a name and slug, and open it in the builder."
---

<Steps>
  <Step title="Log in to your account">
    Head over to [https://curriculos.ia.br](https://curriculos.ia.br) and log in with your account credentials.
...
<Step title="Click “Create a new resume”">
  ...
  <Step title="Review (or edit) the slug">
    ...
    <Warning>
      If you choose to publicly share your resume, it will be accessible at `https://curriculos.ia.br/{username}/{slug}`.
    </Warning>
