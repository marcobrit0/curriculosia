...
description: "Learn how to configure an AI provider and API key for AI-assisted features in Currículos IA"
---

<Steps>
  <Step title="Sign in to the dashboard">
    Head over to [https://curriculos.ia.br](https://curriculos.ia.br) and sign in with your account credentials.
  </Step>
...
<Step title="Navigate to Artificial Intelligence settings">
  ...
  <Step title="How your data is stored and sent">
    ...
    <Info>
      <strong>Your credentials and AI configuration are never saved on Currículos IA servers.</strong> They only live in your device's browser storage.
    </Info>
...
If you have a solution or workaround for this CORS-related limitation, please consider raising an [issue or pull request on GitHub](https://github.com/curriculosia/curriculosia).
