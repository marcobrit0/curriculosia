...
description: "Understand the architecture and codebase structure of Currículos IA"
---

This guide provides a comprehensive overview of Currículos IA's architecture and codebase structure, helping you understand how different parts of the application work together.

---

## Tech Stack Overview

Currículos IA is built with a modern, type-safe stack:
...
**Diagram:** This flow shows data and control flow between the main architectural layers of Currículos IA.
...
Currículos IA uses a hybrid approach:
...
<CardGroup cols={2}>
  <Card title="GitHub Discussions" icon="comments" href="https://github.com/marcobrit0/curriculosia/discussions">
    Ask questions and discuss ideas with the community.
  </Card>
  <Card title="GitHub Issues" icon="bug" href="https://github.com/marcobrit0/curriculosia/issues">
