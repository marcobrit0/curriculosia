...
description: "Help translate Currículos IA into your language using Crowdin"
---

Currículos IA is used by people all around the world, and translations help make the app accessible to everyone. If you speak a language other than English, you can help by contributing translations.

---

## How Translations Work

Currículos IA uses [Crowdin](https://crowdin.com/) as its localization management platform. Crowdin provides a user-friendly interface where translators can contribute translations without needing to write code or work with files directly.

<Info>
  The Currículos IA Crowdin project is available at
  [https://crowdin.com/project/curriculosia](https://crowdin.com/project/curriculosia).
</Info>
...
<Steps>
    ...
    <Step title="Join the Currículos IA Project">
    	Navigate to the [Currículos IA project on Crowdin](https://crowdin.com/project/curriculosia) and click **Join**
...
<Warning>
  ...
  project](https://crowdin.com/project/curriculosia).
</Warning>

To request a new language:

1. Go to the [GitHub Issues](https://github.com/marcobrit0/curriculosia/issues) page
2. Click **New Issue**
3. Select the appropriate template or create a blank issue
4. Title it something like: "Add [Language Name] to Currículos IA"
...
Translations submitted on Crowdin are synced to the codebase periodically. Once merged, they will be included in the next release of Currículos IA.
...
<CardGroup cols={2}>
  ...
  <Card icon="github" title="GitHub Issues" href="https://github.com/marcobrit0/curriculosia/issues">
...
Thank you for helping make Currículos IA accessible to users worldwide!
