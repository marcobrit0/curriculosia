...
description: "Set up a local development environment for Currículos IA"
---
...
This guide walks you through setting up Currículos IA for local development. Whether you're contributing to the project or customizing it for your needs, these steps will get you up and running.
...
<Steps>
  <Step title="Clone the Repository">
    ```bash
    git clone https://github.com/marcobrit0/curriculosia.git
    cd Reactive-Resume
    ```
  </Step>
  ...
  <Step title="Start the Development Server">
    ...
    Your local Currículos IA instance will be available at [http://localhost:3000](http://localhost:3000).
  </Step>
</Steps>
...
Currículos IA uses [Lingui](https://lingui.dev/) for internationalization.
...
// For JSX content
<Trans>Welcome to Currículos IA</Trans>;
```
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Repository" icon="github" href="https://github.com/marcobrit0/curriculosia">
