...
description: "Terms and conditions for using Currículos IA, including accounts, public resumes, uploads, and exports."
---

## Agreement

These Terms of Service (the “Terms”) govern your access to and use of **Currículos IA** (the “Service”). By using the Service, you agree to these Terms.

- **Service Operator**: Marco Brito
- **Contact**: marconmbrito@gmail.com
- **Service URL**: https://curriculos.ia.br
...
<Note>
  ...
  hosted service at <code>curriculos.ia.br</code>, the project's published support contact is{" "}
  <code>marconmbrito@gmail.com</code>.
</Note>
...
Currículos IA is a resume builder that allows you to create, store, and share resumes, upload related assets, and export/print resumes (including generating PDFs and screenshots).
...
Currículos IA is open-source software. These Terms govern **use of the Service**, not the source code repository or
any separate notices that may apply to self-hosted or modified deployments.
