...
<Note>
  **Note for self-hosted deployments:** If you are using the official hosted service at <code>curriculos.ia.br</code>,
  the project's published support contact is <code>marconmbrito@gmail.com</code>. Replace the placeholders above with
