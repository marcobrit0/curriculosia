...
description: "How Currículos IA handles personal data, cookies, uploads, and printing."
---

## Overview

This Privacy Policy explains how **Currículos IA** (the “Service”) collects, uses, stores, and shares information when you use it.

Currículos IA is open-source and can be operated in different ways (for example, by the official hosted service, or by an organization/self-hosted deployment). The specific data controller for your use depends on who operates the instance you are using.
...
<Note>
  **Note for self-hosted deployments:** If you are using the official hosted service at <code>curriculos.ia.br</code>, the
  project's published support contact is <code>marconmbrito@gmail.com</code>. Replace the placeholders above with the
...
Currículos IA is a resume builder that lets you:
