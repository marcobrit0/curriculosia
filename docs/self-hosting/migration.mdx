...
description: "A step-by-step guide to migrate your Currículos IA instance from v4 to v5, including manual and automated migration options."
---

## Overview

This guide walks you through migrating your Currículos IA installation from **v4 to v5**. The migration process involves setting up a new v5 instance alongside your existing v4 instance, then transferring your users and resumes to the new system.
...
<CardGroup cols={2}>
  <Card title="Running v4 Instance">Your existing Currículos IA v4 instance should be running and accessible.</Card>
  <Card title="New v5 Instance">
    A fresh Currículos IA v5 instance set up and running. Follow the [Self-Hosting with Docker](/self-hosting/docker)
...
<Step title="Import into v5">
  ...
  Select the **Currículos IA v4** format 4. Upload your exported JSON file The import process automatically converts the
  v4 format to v5.
</Step>
...
<CardGroup cols={1}>
  ...
  <Card title="Currículos IA Source Code">
    Clone the Currículos IA repository to access the migration scripts: ```bash git clone
    https://github.com/marcobrit0/curriculosia.git cd curriculosia pnpm install ```
  </Card>
</CardGroup>
