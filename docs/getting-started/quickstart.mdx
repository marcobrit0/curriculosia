---
title: "Quickstart"
description: "Get started with Currículos IA in minutes — use our hosted version or deploy your own instance"
---

## Options

Currículos IA offers flexibility in how you want to use it. Choose the option that best fits your needs:
...
The easiest way to use Currículos IA is through our cloud version at [curriculos.ia.br](https://curriculos.ia.br). **This service is completely free and will always remain free.**

<Steps>
	<Step title="Create an Account">
		Visit [curriculos.ia.br](https://curriculos.ia.br) and sign up for free using your email, or sign in with your GitHub or Google
		account.
	</Step>
...
For users who prefer complete control over their data, you can deploy Currículos IA on your own infrastructure using Docker.
...
<Steps>
	<Step title="Clone the Repository">
		```bash git clone https://github.com/marcobrit0/curriculosia.git cd Reactive-Resume ```
	</Step>
    ...
    <Step title="Configure Environment Variables">
    	...
    	S3_BUCKET=curriculosia S3_FORCE_PATH_STYLE=true ```
    	<Warning>
    ...
    <Step title="Start the Services">
    	...
    	**SeaweedFS** — S3-compatible storage for file uploads - **Printer** — PDF and screenshot generation service
    	(browserless/chromium) - **Currículos IA** — The main application
    </Step>

    <Step title="Access Your Instance">
    	Once all services are running, access your Currículos IA instance at: ``` http://localhost:3000 ```
    </Step>
...
| `app`       | 3000 | The main Currículos IA application                          |
...
| `APP_URL`          | Public URL of your Application | `https://curriculos.ia.br`              |
...
<Note>
  **Hybrid Setup Note**: The `PRINTER_APP_URL` variable is required when running Currículos IA outside of Docker while
...
<CardGroup cols={2}>
  <Card title="Development Setup" icon="code" href="/contributing/development">
    Set up a development environment to contribute or customize Currículos IA.
  </Card>
...
<Note>
  **Having trouble?** Check our [GitHub Issues](https://github.com/marcobrit0/curriculosia/issues) or reach out via
  [email](mailto:marconmbrito@gmail.com).
</Note>
