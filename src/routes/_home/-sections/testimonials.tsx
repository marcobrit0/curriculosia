...
const testimonials: string[] = [
  ...
  "I want to appreciate you for making your projects #openSource, most especially your Currículos IA, which is the handiest truly-free resume maker I've come across. This is a big shoutout to you. Well done!",
  ...
  "Wow, what an impressive profile! You are very talented. I'm also a fellow SWE on the job hunt and I came across a linked to Currículos IA on Reddit and gave it a shot. This could easily be a paid product. Very clean and useful.",

  "Thank you for creating Currículos IA. It is an amazing product, and I love the design and how it simplifies the resume-making experience. I've been trying to create a good resume for a decade to find my first job in tech, and your tool has been incredibly helpful.",
];
    ...
    <section id="testimonials" className="overflow-hidden py-12 md:py-16 xl:py-20">
      ...
      >
        ...
        <p className="max-w-4xl leading-relaxed text-balance text-muted-foreground">
          <Trans>
            A lot of people have written to me over the years to share their experiences with Currículos IA and how it
