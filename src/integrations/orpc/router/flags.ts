...
export const flagsRouter = {
  get: publicProcedure
    .route({
      ...
      description:
        "Returns the current feature flags for this Currículos IA instance. Feature flags control instance-wide settings such as whether new user signups or email-based authentication are disabled. No authentication required.",
